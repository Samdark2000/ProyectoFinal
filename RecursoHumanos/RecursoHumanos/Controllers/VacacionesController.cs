...
namespace RecursoHumanos.Controllers
{
    public class VacacionesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Emplado,Desde,Hasta,Años,Comentarios")] Vacaciones vacaciones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Emplado,Desde,Hasta,Años,Comentarios")] Vacaciones vacaciones)
        {
            if (ModelState.IsValid)
            {
